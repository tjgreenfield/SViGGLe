    ...
    namespace Element
    {
        ...
        void Rect::buffer(double tolerance)
        {
            ...
            else
            {
                ...
                commandSet.emplace_back(new PathCommand::MoveTo(x + rx_, y));
                commandSet.emplace_back(new PathCommand::LineTo(x + width - rx_, y));
                commandSet.emplace_back(new PathCommand::EllipticalTo(Point(x + width, y + ry_), rx_, ry_, 0, 0, 1, commandSet.back().get()));
                commandSet.emplace_back(new PathCommand::LineTo(x + width, y + height - ry_));
                commandSet.emplace_back(new PathCommand::EllipticalTo(Point(x + width - rx_, y + height), rx_, ry_, 0, 0, 1, commandSet.back().get()));
                commandSet.emplace_back(new PathCommand::LineTo(x + rx_, y + height));
                commandSet.emplace_back(new PathCommand::EllipticalTo(Point(x, y + height - ry_), rx_, ry_, 0, 0, 1, commandSet.back().get()));
                commandSet.emplace_back(new PathCommand::LineTo(x, y + ry_));
                commandSet.emplace_back(new PathCommand::EllipticalTo(Point(x + rx_, y), rx_, ry_, 0, 0, 1, commandSet.back().get()));
                commandSet.emplace_back(new PathCommand::ClosePath());
            }
