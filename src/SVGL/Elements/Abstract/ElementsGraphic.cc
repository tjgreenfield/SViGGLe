...
namespace SVGL
{
    namespace Elements
    {
         ...
         */
        const CSS::Element* Graphic::getParent() const
        {
         ...
         */
        const CSS::Element* Graphic::getPrevSibling() const
        {
         ...
         */
        const CSS::Element* Graphic::getPrevChild(const Graphic*) const
        {
            return nullptr;
        }
